...
export default async function TopMenu() {
  ...
  return (
    <div className="navbar bg-black/[0.6] justify-between fixed top-0 z-[100] border-solid border-black border-2">
      <div className="flex flex-row sm:ml-3 ml-0 text-white">
